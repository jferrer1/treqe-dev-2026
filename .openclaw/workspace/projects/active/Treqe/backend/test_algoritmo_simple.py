#!/usr/bin/env python3
"""
Test del algoritmo simple con datos demo
"""
...
async def test_algoritmo_simple():
    """Test del algoritmo simple"""
    print("=" * 60)
    print("TEST ALGORITMO TREQE SIMPLE (MVP)")
    print("=" * 60)
    ...
    try:
        ...
        from src.core.algorithm_simple import TreqeMatchingEngineSimple
        ...
        async with async_session() as session:
            ...
            # Crear motor de matching simple
            print("\n3. Creando motor de matching simple...")
            engine = TreqeMatchingEngineSimple()
            
            # Test para cada usuario
            print("\n4. Probando algoritmo simple:")
            ...
            if ana:
                ...
                if proposals:
                    ...
                    if circular_found:
                        ...
                        print(f"   ALGORITMO SIMPLE FUNCIONA CORRECTAMENTE!")
                    else:
            ...
            if proposals and any(p['k_size'] == 3 for p in proposals):
                print("ALGORITMO TREQE SIMPLE VALIDADO EXITOSAMENTE")
                print("\nEl algoritmo simple encontro el intercambio circular k=3:")
                ...
                print("El algoritmo simple NO encontro el intercambio circular k=3")
                print("   Revisar logica de matching")
                return False
...
if __name__ == "__main__":
    print("TEST DEL ALGORITMO TREQE SIMPLE (MVP)")
    print("Objetivo: Verificar algoritmo simple encuentra intercambio circular k=3")
    
    resultado = asyncio.run(test_algoritmo_simple())
    
    if resultado:
        print("\n" + "=" * 60)
        print("TEST COMPLETADO CON EXITO")
        print("=" * 60)
        print("\nEl algoritmo simple funciona y esta listo para MVP.")
    else:
        print("\nTest fallo")
        sys.exit(1)