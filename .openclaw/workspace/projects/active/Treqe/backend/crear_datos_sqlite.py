#!/usr/bin/env python3
"""
Script para crear datos demo usando SQLite (sin PostgreSQL)
"""
...
async def main():
    """Función principal"""
    print("SISTEMA DE DATOS DEMO - TREQE (SQLite)")
    print("=" * 60)
    ...
    try:
        ...
        async with async_session() as session:
            ...
            # Mostrar resumen
            print("\n" + "=" * 60)
            print("RESUMEN - DATOS DEMO CREADOS EN SQLite")
            print("=" * 60)
...
if __name__ == "__main__":
    ...
    if resultado:
        print("\n" + "=" * 60)
        print("EXITO: Datos demo creados en SQLite")
        print("=" * 60)
        print("\nEl sistema ahora tiene 3 usuarios con intercambio circular k=3:")
        print("* Ana: iPhone EUR600 -> busca MacBook EUR800")
        print("* Carlos: MacBook EUR800 -> busca Bicicleta EUR400")
        print("* Beatriz: Bicicleta EUR400 -> busca iPhone EUR600")
        print("\nBase de datos: treqe_demo.db")
        print("\nPara probar el algoritmo:")
        print("1. Cambiar DATABASE_URL en config.py a SQLite")
        print("2. Ejecutar: uvicorn src.main:app --reload")
        print("3. Probar endpoint POST /api/v1/matching/find")
    else:
